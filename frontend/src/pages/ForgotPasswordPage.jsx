...
import { resetPassword, generateOtp } from '../api';
...
const ForgotPasswordPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await resetPassword(formData.email, formData.newPassword, formData.otp);
            alert('Password reset successful! Please login.');
            navigate('/login');
        } catch (err) {
            setError('Failed to reset password. Invalid OTP or Email.');
        }
    };
    ...
    return (
        ...
        >
            <div className="text-center mb-8">
                ...
                <p className="text-gray-400 mt-2">Enter your email and new password</p>
            </div>
