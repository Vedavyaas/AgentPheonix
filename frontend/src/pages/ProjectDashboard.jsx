...
import { User, Settings, X, Cloud } from 'lucide-react';
import CredentialsPage from './CredentialsPage';
import CloudCredentialsPage from './CloudCredentialsPage';
                        ...
                        >
                            ...
                            <div className="flex-1 p-6 space-y-2">
                                ...
                                >
                                    ...
                                    <span className="font-medium">Cloud Credentials</span>
                                </button>
                            </div>
            ...
            <AnimatePresence>
                {activePanel === 'cloud' && (
                    <>
                        ...
                        {/* Cloud Credentials Slide-out Panel */}
                        <motion.div
                            initial={{ x: '100%' }}
                            animate={{ x: 0 }}
                            exit={{ x: '100%' }}
